        ...
        while quantidade_valida == False:
            try:
                ...
                if quantidade_alunos < 5:
                    print("A quantidade mínima de alunos por turma é 5")
                    continue

                if quantidade_alunos > 20:
                    print("A quantidade máxima de alunos por turma é 20")    
                    continue
...
def numero_inteiro():
    ...
    # Verificar se o número é menor ou maior que 15
    if numero < 15:
...
# Calcular a quantidade de caracteres do nome
    quantidade_caracteres = len(nome_animal)
# Apresentar a quantidade de caracteres
...
def solicitar_texto():
    ...
    # Remover os espaços do começo e transformar em minúsculo
...
def nome_empresa():
    ...
    # Remover 'LTDA' e 'SA' do nome da empresa
    nome_empresa_processado = nome_empresa.replace("LTDA", "").replace("SA", "")

    # Exibir o nome da empresa sem 'LTDA' e 'SA'
...
def nome_curso_super_dev():
    ...
    # Verificar se o curso começa com "SuperDev"
