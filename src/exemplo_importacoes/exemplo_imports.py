# Importação1: importando o arquivo somente com import
...
from src.exemplo05_for import exemplo_relogio, exemplo_apresentar_contagem_regressiva

def executar():
    # Importação1: utilização da importação devo passar o caminho completo e o método
